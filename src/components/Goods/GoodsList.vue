        ...
        <ul ref="ul">
            <li v-for="goods in goodsList" :key="goods.id">
                ...
                <router-link :to="{name:'goods.detail',params:{goodsId:goods.id}}">
                    ...
                    <div class="title">{{goods.title|convertTitle(23)}}</div>
                    <div class="desc">
                        <div class="sell">
...
export default{
    ...
    methods:{
        ...
        loadBottom(){
            ...
            .then(res=>{
                ...
                // 追加下一页的数据
                this.goodsList = this.goodsList.cancat(res.data.message);
                this.page++;
                //从loading 状态通过到pull 初始化状态
    ...
    data(){
        return {
            goodsList:[],//商品列表
            isAutoFill:false,//S数据是否自动检测，并调用loadBottom
